    ...
    <section className="bg-gray-900 text-white min-h-screen flex flex-col">
      ...
      <div className="container mx-auto flex-grow flex items-center">
        <div className="flex justify-between items-center w-full">
          <div>
            <h1 className="text-4xl font-bold mb-2">I'M <span className="text-orange-500">Alexander Puga</span></h1>
          ...
          <div className="relative">
            ...
            <div className="absolute top-0 right-0 bottom-0 left-0 border-2 border-orange-500 rounded-full transform translate-x-4 translate-y-4"></div>
          </div>
        </div>
      </div>
      <Socials />
